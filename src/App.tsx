...
function App() {
  ...
  const isLoser = incorrectLetters.length > BODY_PARTS_COUNT;
  ...
  useEffect(() => {
    ...
    //Need to add guessedLetters to [] to update the guessedLetters everytime the event takes place
  }, [guessedLetters]);
